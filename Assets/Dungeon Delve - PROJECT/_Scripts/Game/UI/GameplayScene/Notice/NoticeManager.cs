...
public class NoticeManager : Singleton<NoticeManager>
{
    ...
    //
    [SerializeField, BoxGroup("Notice type 4")] private Animator yellowNotice;
    [SerializeField, BoxGroup("Notice type 4")] private Animator blueNotice;
    [SerializeField, BoxGroup("Notice type 4")] private TextMeshProUGUI yellowTextNotice;
    [SerializeField, BoxGroup("Notice type 4")] private TextMeshProUGUI blueTextNotice;
    //
    ...
    public void OpenYellowTextNoticeT4(string _noticeText)
    {
        yellowTextNotice.text = _noticeText;
        yellowNotice.Play("Panel_IN");
    }
    public void OpenBlueTextNoticeT4(string _noticeText)
    {
        blueTextNotice.text = _noticeText;
        blueNotice.Play("Panel_IN");
    }
    #endregion
