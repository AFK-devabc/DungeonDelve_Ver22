...
public class EnemyController : Damageable, IPooled<EnemyController>
{
    ...
    protected override void OnEnable()
    {
        ...
        if (_hasRefPlayer) return;
        _hasRefPlayer = true;
        SetRefTarget(_player.gameObject);
    }
    private void Start()
    {
    ...
    public void SetRefTarget(GameObject _value) => Blackboard.SetVariableValue("Player", _value);
